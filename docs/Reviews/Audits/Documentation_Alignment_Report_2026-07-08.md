...
2. **Adopt OniForgeâ€™s structure and decision discipline.**
...
| Review artifacts are stored under an audit-date folder. | OniForgeâ€™s `docs/reviews/` model is cleaner and should be reused. |
...
This structure follows OniForgeâ€™s discipline while staying CalradiaForge-specific.
...
It does not need to be as long as OniForgeâ€™s catalog/data documents unless the CalradiaForge subsystem has equivalent complexity.

## 8. Priority Work Plan

### Phase 0 â€” Documentation Stabilization
...
### Phase 3 â€” Data, Persistence, and Application Systems
...
### Phase 4 â€” Nexus Documentation Consolidation
...
### Phase 5 â€” UI and Development Workflow
...
### Phase 6 â€” ADRs and Ongoing Maintenance
...
### 11.4 Preserve â€œcurrently implementedâ€ versus â€œplannedâ€ labels
...
CalradiaForge does not need OniForgeâ€™s exact amount of data-pipeline documentation. It does need OniForgeâ€™s stronger documentation foundation because CalradiaForge has several safety-sensitive and release-sensitive areas:
